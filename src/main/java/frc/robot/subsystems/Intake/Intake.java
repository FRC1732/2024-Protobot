...
public class Intake extends SubsystemBase {
  ...
  public Intake() {
    ...
    intakeLCanSparkMax = new CANSparkMax(IntakeConstants.INTAKE_MOTOR_L_CAN_ID,  CANSparkMax.MotorType.kBrushless);
    intakeRCanSparkMax = new CANSparkMax(IntakeConstants.INTAKE_MOTOR_R_CAN_ID, CANSparkMax.MotorType.kBrushless);
