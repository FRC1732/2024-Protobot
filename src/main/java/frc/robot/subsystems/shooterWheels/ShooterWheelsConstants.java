...
public class ShooterWheelsConstants {
  ...
  public static final double SHOOTER_SPEED_AMP = 0.5;
  public static final double SHOOTER_SPEED_TRAP = 0.5;
  public static final double SHOOTER_SPEED_115 = 0.5;
  public static final double SHOOTER_SPEED_125 = 0.5;
  public static final double SHOOTER_SPEED_150 = 0.5;
  public static final double SHOOTER_SPEED_BACKWARDS = 0.5;
}
