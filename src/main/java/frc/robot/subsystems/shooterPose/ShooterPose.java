...
public class ShooterPose extends SubsystemBase {
  ...
  public ShooterPose() {
    ...
    angleLookupTable.put(50.0, -43.0 + sweepingAngleAdjustment); //adjust elevator with any angles before
    ...
    angleLookupTable.put(130.0, -23.5 + -2.0 + sweepingAngleAdjustment);//adjust angle of robot with any angles above
